...
export class AuthorizeService {
  ...
  //    redirect flow.
  async signIn(state: any): Promise<IResultAuth> {
    await this.ensureUserManagerInitialized();
    try {
  ...
  async completeSignIn(url: string): Promise<IResultAuth> {
    try {
      await this.ensureUserManagerInitialized();
  ...
  async signOut(state: any): Promise<IResultAuth> {
    await this.ensureUserManagerInitialized();
    try {
      if (this._popUpDisabled) {
        throw new Error(
  ...
  //todo ::
  async completeSignOut(url: string): Promise<IResultAuth> {
    await this.ensureUserManagerInitialized();
    try {
