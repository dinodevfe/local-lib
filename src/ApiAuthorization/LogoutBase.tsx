...
type _LogoutBaseProps = LoadingDispatchProps & LogoutProps;
export class LogoutBase extends Component<_LogoutBaseProps, LogoutState> {
  constructor(props: _LogoutBaseProps) {
    super(props);
  ...
  getReturnUrl(state?: any) {
    ...
    return (
      ...
      fromQuery ||
      `${ApplicationPaths.Origin()}${process.env.PUBLIC_URL}${
