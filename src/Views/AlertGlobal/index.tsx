...
export function AlertGlobal() {
    ...
    const _HandleClose = useCallback((data: MessageData) => {
...
const Message: FC<MessageProps> = (props) => {
    ...
    return <Alert onClose={_handleClose} severity={props.data.type} >
        {props.data.text}
    </Alert>
}
        ...
        <div>
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button onClick={_handleClose} color='error'>Cancel</Button>
                </DialogActions>
            </Dialog>
        </div>
    );
